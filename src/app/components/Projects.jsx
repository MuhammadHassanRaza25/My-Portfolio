...
export default function Projects() {
  return (
    <>
      ...
      <div
        id="projects"
        className="container flex lg:px-14 px-5 mt-5 lg:flex-row flex-col items-center justify-evenly min-h-[530px]"
      >
        <MotionUp delay={0.1}>
          <CardContainer className="inter-var w-full my-4 flex items-stretch lg:mb-0">
