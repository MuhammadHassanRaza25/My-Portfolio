      ...
      content: (
        <div className="flex flex-col gap-5 lg:w-[430px] lg:h-auto bg-gray-50 rounded-lg border-b-2 border-blue-700 pb-5 pt-5 px-3">
          ...
          <ul className="list-disc text-sm space-y-2 lg:px-9 pl-9 pr-2 text-gray-800 font-semibold">
            <li>Developed and maintained scalable web applications using React.js and Next.js, with a strong focus on responsive design and reusable components.</li>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-5 lg:w-[430px] lg:h-auto bg-gray-50 rounded-lg border-b-2 border-blue-700 pb-5 pt-5 px-3">
          ...
          <ul className="list-disc text-sm space-y-2 lg:px-9 pl-9 pr-2 text-gray-800 font-semibold">
            <li>Collaborated with an international team to develop and maintain scalable web applications, including an advanced admin dashboard, using React.js.</li>
            <li>Improved application performance by applying best practices in code structure, state management, and load time optimization.</li>
