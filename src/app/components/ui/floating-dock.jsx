...
import { AnimatePresence, motion, useScroll, useMotionValue, useMotionValueEvent, useSpring, useTransform } from "framer-motion";
...
const FloatingDockMobile = ({
  ...
  return (
    (<div className={cn("fixed left-[85vw] bottom-[3vw] block md:hidden", className)}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId="nav"
...
const FloatingDockDesktop = ({
  ...
  const [visible, setVisible] = useState(true);  // Initially set navbar to visible
  ...
  return (
    (<motion.div
      ...
      animate={{
        y: visible ? 0 : -100,  // Move the navbar to the top (offscreen) when not visible
        opacity: visible ? 1 : 0,  // Control opacity for the fade-in/out effect
      }}
      transition={{
