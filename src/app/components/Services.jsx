...
export default function Services() {
  return (
    <>
      ...
      <div className="container servicesCardDiv lg:px-14 px-5 mt-8 flex items-center justify-evenly min-h-[360px]">
        <MotionUp delay={0.1}>
          <div className="serviceCard shadow transition-all hover:-translate-y-2 flex flex-col justify-center gap-5 lg:w-[330px] lg:h-[300px] bg-white rounded-lg border px-3">
